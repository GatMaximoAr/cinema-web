...
def test_can_get_success_response(url, api_client_with_credentials, given_cinema_rooms):
...
@pytest.mark.django_db
def test_can_reject_unauthorized_request(url, api_client, given_cinema_rooms):
