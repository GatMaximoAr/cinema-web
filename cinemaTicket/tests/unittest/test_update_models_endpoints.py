...
pytestmark =  pytest.mark.parametrize("url, data", [
...
def test_can_get_success_response(url, api_client_with_credentials, data, given_cinema_rooms):
...
@pytest.mark.django_db
def test_can_reject_malformed_request_body(url, data, api_client_with_credentials, given_cinema_rooms):
